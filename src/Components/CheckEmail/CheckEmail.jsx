...
function CheckEmail() {
  return (
    <div className="container py-3">
      ...
      <div className="row">
        <div className="col-md-6 my-5 p-3 text-center">
          <h5 className="mb-3">Activation link has been sent to your email.</h5>
          <h5 className="text-center">Please Check Your Email Inbox.</h5>
          <div className="mt-4">
            <Link to={"/login"} className="btn text-white btn-success">Login Now</Link>
          </div>
        </div>
        <div className="col-md-6 md-5 border-0 text-center">     
            <h5 className="mt-md-5">Can't find the email?</h5>
